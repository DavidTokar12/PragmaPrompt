...
from prompt_craft_kit.exceptions import FileNotFoundError
...
from prompt_craft_kit.runtime_context import exec_stack_guard as rt_exec_guard
from prompt_craft_kit.runtime_context import sections as rt_sections
from prompt_craft_kit.runtime_context import session as rt_session
...
def render_path(
    ...
    with (
        ...
        try:
            ...
            parts = [s.body for s in rt_sections()]
            return "\n".join(parts)
        finally:
